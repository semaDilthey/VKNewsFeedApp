...
//  ТитлВью, расположено в шапке с поиском и аватаром
...
class TitleView: UIView {
    ...
    // view которое добавляют на NavBar подстраивается под размер этого навБара. Для этого надо использовать этот метод
